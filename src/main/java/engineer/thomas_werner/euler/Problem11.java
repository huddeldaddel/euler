...
public class Problem11 {
    ...
    public static void main(String[] args) {
        final Problem11 problem11 = new Problem11();
    ...
    long getMaxAdjacentNumberProductDiagonal1(final Grid grid) {
        ...
        for(int row=0; row<20 -SEQUENCE_SIZE; row++) {
            for(int column=0; column<20 -SEQUENCE_SIZE; column++) {
                long product = 1;
                for(int i=0; i<SEQUENCE_SIZE; i++)
                    product *= grid.get(row + i, column + i);
                result = Math.max(result, product);
            }
        }
        return result;
    ...
    static class Grid {
        ...
        public Grid() {
            ...
            for(int i=0; i<20; i++) {
                final String[] numbers = lines[i].split(" ");
                for(int j=0; j<20; j++)
